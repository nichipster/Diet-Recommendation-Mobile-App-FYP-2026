...
def upgrade() -> None:
    """Upgrade schema."""
    # Fix 1: PostgreSQL cannot auto-cast VARCHAR -> enum; must supply USING clause
    ...
    # Fix 2: server_default=sa.false() so existing rows get a value for NOT NULL columns
    # Fix 3: sa.String() replaces sqlmodel.sql.sqltypes.AutoString() (sqlmodel not imported)
