...
from .routers import (auth, user_profile, account, user, user_preferences, dietary_goal, meal,
                       food, recommendations, recipes, image_recognition, admin_stats, admin_users,
                       admin)
