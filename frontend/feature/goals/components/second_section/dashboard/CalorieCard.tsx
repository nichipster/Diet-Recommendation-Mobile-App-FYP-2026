...
const styles = StyleSheet.create({
  summaryCard: {
    ...
    shadowOpacity: 0.1, shadowRadius: 20, elevation: 8, marginBottom: 24,
  },
  ...
  progressBarContainer: {
    backgroundColor: '#f3f4f6', height: 16, borderRadius: 999,
    marginBottom: 16, overflow: 'hidden',
  },
  progressBarFill: {
    backgroundColor: '#10b981', height: '100%', borderRadius: 999,
  },
  ...
  macroProgressBg: {
    width: '80%', height: 4, backgroundColor: '#f3f4f6',
