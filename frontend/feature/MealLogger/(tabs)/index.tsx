...
import AddMealMenu from "../components/add-meal-menu"; // default export
      ...
      <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
        ...
        <View style={styles.section}>
          ...
          <MealList
            ...
            onEditMeal={(meal) => setEditingMeal(meal)} // modal opens via useEffect
          />
        </View>
